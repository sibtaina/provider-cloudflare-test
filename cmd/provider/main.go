...
import (
	...
	"github.com/sibtaina/provider-cloudflare-test/apis"
	"github.com/sibtaina/provider-cloudflare-test/apis/v1alpha1"
	"github.com/sibtaina/provider-cloudflare-test/config"
	"github.com/sibtaina/provider-cloudflare-test/internal/clients"
	"github.com/sibtaina/provider-cloudflare-test/internal/controller"
	"github.com/sibtaina/provider-cloudflare-test/internal/features"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-cloudflare-test"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-cloudflare-test",
		Cache: cache.Options{
